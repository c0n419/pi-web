...
test("falls back to English and returns the key when both are missing", () => {
  ...
  assert.equal(translateMessage("tr", "common.ok", { en: { "common.ok": "OK" }, tr: {} }), "OK");
...
test("formats relative time using the selected locale", () => {
  ...
  assert.equal(formatRelativeTime(new Date("2026-01-01T00:05:00.000Z"), "tr", now), "5 dakika sonra");
