...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "panes.activeSessions": "已打开的会话",
    "panes.unsaved": "新会话",
    "panes.addPane": "添加会话窗格",
    "panes.closePane": "关闭窗格 {number}",
    "panes.maximum": "最多可打开四个窗格",
    "panes.switchTo": "切换到 {name}",
    "panes.paneLabel": "会话窗格 {number}",
    "panes.workingDirectory": "工作目录",
    "panes.changeDirectory": "更改目录…",
    "panes.selectProjectForPane": "为此窗格选择项目",
    "panes.maximize": "最大化面板",
    "panes.restore": "还原布局",
    "panes.layout": "布局",
    "panes.layoutAuto": "自动网格",
    "panes.layout1x1": "单面板 (1x1)",
    "panes.layout1plus2": "分屏 (1+2)",
    "panes.layout2x1": "双列 (2x1)",
    "panes.layout2x2": "网格 (2x2)",
    "panes.broadcast": "广播模式",
    "panes.broadcastTitle": "向多个面板同时发送消息",
    "panes.broadcastSend": "发送至 {count} 个面板",
    "panes.broadcastPlaceholder": "输入向已选面板广播的消息...",
    "panes.handoff": "传送",
    "panes.handoffTo": "发送至面板 {number}",
    "panes.handoffLastResponse": "发送最新回复至面板 {number}",
    "panes.handoffContext": "发送会话摘要至面板 {number}",
    ...
    "sidebar.newSessionInProject": "在项目新建会话",
    "sidebar.selectDirectoryForNewSession": "为新会话选择目录…",
    "sidebar.refresh": "刷新",
    "sidebar.selectProject": "选择项目…",
    "sidebar.filterProjects": "筛选项目…",
    "sidebar.searchSessions": "搜索会话…",
    "sidebar.showSubagents": "显示 {count} 个子代理会话",
    "sidebar.hideSubagents": "隐藏已完成的子代理会话",
