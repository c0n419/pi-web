...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "theme.catppuccin": "Catppuccin Themes",
    "theme.developer": "Developer Themes",
    "theme.standard": "Standard Themes",
    ...
    "panes.activeSessions": "Open sessions",
    "panes.unsaved": "New session",
    "panes.addPane": "Add session pane",
    "panes.closePane": "Close pane {number}",
    "panes.maximum": "A maximum of four panes can be open",
    "panes.switchTo": "Switch to {name}",
    "panes.paneLabel": "Session pane {number}",
    "panes.workingDirectory": "Working directory",
    "panes.changeDirectory": "Change directory…",
    "panes.selectProjectForPane": "Select project for this pane",
    "panes.maximize": "Maximize pane",
    "panes.restore": "Restore layout",
    "panes.layout": "Layout",
    "panes.layoutAuto": "Auto Grid",
    "panes.layout1x1": "Single (1x1)",
    "panes.layout1plus2": "Split (1+2)",
    "panes.layout2x1": "Columns (2x1)",
    "panes.layout2x2": "Grid (2x2)",
    "panes.broadcast": "Broadcast",
    "panes.broadcastTitle": "Multi-pane broadcast mode",
    "panes.broadcastSend": "Send to {count} panes",
    "panes.broadcastPlaceholder": "Broadcast message to selected panes...",
    "panes.handoff": "Handoff",
    "panes.handoffTo": "Send to Pane {number}",
    "panes.handoffLastResponse": "Send last response to Pane {number}",
    "panes.handoffContext": "Send session context to Pane {number}",
    ...
    "sidebar.selectDirectoryForNewSession": "Select directory for new session…",
    "sidebar.refresh": "Refresh",
    "sidebar.selectProject": "Select project…",
    "sidebar.filterProjects": "Filter projects…",
    "sidebar.searchSessions": "Search sessions…",
    "sidebar.showSubagents": "Show {count} subagent sessions",
    "sidebar.hideSubagents": "Hide finished subagent sessions",
